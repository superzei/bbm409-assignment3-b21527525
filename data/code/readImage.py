...
def load_all():
    """ load all given data in current folder """
    train = io.loadmat('data/code/train.mat')
    test = io.loadmat('data/code/test.mat')
    validation = io.loadmat('data/code/validation.mat')
    return train, validation, test


def load_data(path):
    """ load matrix from given path """
